 ...
 * @author flymegoc
 */
public class SettingActivity extends MvpActivity<SettingView, SettingPresenter> implements View.OnClickListener,
        SettingView {
    ...
    private void initSettingSection() {
        ...
        //91pron地址
        QMUICommonListItemView addressItemWithChevron = qmuiGroupListView.createItemView(getString(R.string
                .address_v9porn));
        ...
        //91论坛地址
        QMUICommonListItemView forumAddressItemWithChevron = qmuiGroupListView.createItemView(getString(R.string
                .address_forum_9porn));
        ...
        //ZhuGuLi视频地址
        QMUICommonListItemView pigAvAddressItemWithChevron = qmuiGroupListView.createItemView(getString(R.string
                .address_pa));
        ...
        //Axgle视频地址设置
        QMUICommonListItemView axgleAddressItemWithChevron = qmuiGroupListView.createItemView(getString(R.string
                .address_axgle));
        axgleAddressItemWithChevron.setOrientation(QMUICommonListItemView.VERTICAL);
        String axgleAddress = presenter.getAxgleAddress();
        axgleAddressItemWithChevron.setDetailText(TextUtils.isEmpty(axgleAddress) ? "请设置API地址(注意，是带“api”字的地址)" :
                axgleAddress);
        axgleAddressItemWithChevron.setAccessoryType(QMUICommonListItemView.ACCESSORY_TYPE_CHEVRON);

        //草榴地址
        QMUICommonListItemView t6yAddressItemWithChevron = qmuiGroupListView.createItemView(getString(R.string
                .address_t6y));
        ...
        //播放引擎
        QMUICommonListItemView playEngineItemWithChevron = qmuiGroupListView.createItemView(getString(R.string
                .playback_engine));
        ...
        showUrlRedirectTipDialogItemWithSwitch.getSwitch().setOnCheckedChangeListener(new CompoundButton
        ...
        fixMainNavigationItemWithSwitch.getSwitch().setOnCheckedChangeListener(new CompoundButton
                .OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
    ...
    private void showIsMoveOldDirVideoFileToNewDirDialog(final String newDirPath, final QMUICommonListItemView
    ...
    private void showAddressSettingDialog(final QMUICommonListItemView qmuiCommonListItemView, final String key) {
        ...
        final AppCompatAutoCompleteTextView autoCompleteTextView = view.findViewById(R.id
                .atv_dialog_address_setting_address);
        ...
        switch (key) {
            case AppPreferencesHelper.KEY_SP_PORN_91_VIDEO_ADDRESS:
                ...
                if (!TextUtils.isEmpty(presenter.getVideo9PornAddress())) {
                    RetrofitUrlManager.getInstance().putDomain(Api.PORN9_VIDEO_DOMAIN_NAME, presenter
                            .getVideo9PornAddress());
                }
                break;
            case AppPreferencesHelper.KEY_SP_FORUM_91_PORN_ADDRESS:
                if (!TextUtils.isEmpty(presenter.getForum9PornAddress())) {
                    RetrofitUrlManager.getInstance().putDomain(Api.PORN9_FORUM_DOMAIN_NAME, presenter
                            .getForum9PornAddress());
                }
                break;
            case AppPreferencesHelper.KEY_SP_PIG_AV_ADDRESS:
     ...
     */
    private void saveToSpAndUpdateQMUICommonListItemView(String key, QMUICommonListItemView qmuiCommonListItemView,
                                                         String address) {
        switch (key) {
            case AppPreferencesHelper.KEY_SP_PORN_91_VIDEO_ADDRESS:
    ...
    private void showConfirmDialog(final QMUICommonListItemView qmuiCommonListItemView, final String address, final
    String key) {
    ...
    private void showForbiddenReleaseMemoryTipInfoDialog() {
        ...
        builder.setMessage
                ("为了获得较好的体验，新版本程序占用内存较高，这可能导致后台运行而系统内存不足时成为系统回收内存的优先对象（尤其在低内存手机上），因此我做了自动释放内存功能，但这同时也会使体验有所下降，你可以强制关闭次功能，建议开启");
