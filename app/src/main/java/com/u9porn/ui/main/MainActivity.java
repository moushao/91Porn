...
public class MainActivity extends MvpActivity<MainView, MainPresenter> implements MainView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        presenter.setPorn9VideoAddress(Api.PORN9_VIDEO_DOMAIN_NAME);
        presenter.setPorn9ForumAddress(Api.PORN9_FORUM_DOMAIN_NAME);
    ...
    private void showVideoBottomSheet(final int checkIndex) {
        new QMUIBottomSheet.BottomListSheetBuilder(this, true)
                .addItem(ResourceUtil.getDrawable(this, R.drawable.ic_search_black_24dp), Tags
                        .TAG_SEARCH_PORN_AXGLE_VIDEO)
    ...
    private void initBottomNavigationBar(@IntRange(from = 0, to = 4) int position) {
        bottomNavigationBar.addItem(new BottomNavigationItem(ResourceUtil.getDrawable(this, R.drawable
                .ic_video_library_black_24dp), R.string.title_video));
        bottomNavigationBar.addItem(new BottomNavigationItem(ResourceUtil.getDrawable(this, R.drawable
                .ic_photo_library_black_24dp), R.string.title_photo));
        bottomNavigationBar.addItem(new BottomNavigationItem(ResourceUtil.getDrawable(this, R.drawable
                .ic_library_books_black_24dp), R.string.title_forum));
        bottomNavigationBar.addItem(new BottomNavigationItem(ResourceUtil.getDrawable(this, R.drawable
                .ic_library_music_black_24dp), R.string.title_music));
        bottomNavigationBar.addItem(new BottomNavigationItem(ResourceUtil.getDrawable(this, R.drawable
                .ic_menu_black_24dp), R.string.title_me));
    ...
    private void handlerContentMargin() {
        ...
        CoordinatorLayout.LayoutParams layoutParams = (CoordinatorLayout.LayoutParams) contentFrameLayout
                .getLayoutParams();
        ...
        switch (position) {
            ...
            case 2:
                ...
                mCurrentFragment = FragmentUtils.switchContent(fragmentManager, mCurrentFragment, 
                        mMain9ForumFragment, contentFrameLayout.getId(), position, false);
                showFloatingActionButton(fabSearch);
                break;
            case 3:
                ...
                mCurrentFragment = FragmentUtils.switchContent(fragmentManager, mCurrentFragment, mMusicFragment, 
                        contentFrameLayout.getId(), position, false);
            ...
            case 4:
                ...
                mCurrentFragment = FragmentUtils.switchContent(fragmentManager, mCurrentFragment, mMineFragment, 
                        contentFrameLayout.getId(), position, false);
                hideFloatingActionButton(fabSearch);
                break;
            default:
    ...
    private void handlerFirstTabClickToShow(String tag, int itemId, boolean isInnerReplace) {
        switch (tag) {
            case Tags.TAG_PRON_9_VIDEO:
                ...
                mCurrentFragment = FragmentUtils.switchContent(fragmentManager, mCurrentFragment, 
                        mMain9PronVideoFragment, contentFrameLayout.getId(), itemId, isInnerReplace);
            ...
            case Tags.TAG_PXGAV_VIDEO:
                ...
                mCurrentFragment = FragmentUtils.switchContent(fragmentManager, mCurrentFragment, mMainPxgavFragment,
                        contentFrameLayout.getId(), itemId, isInnerReplace);
            ...
            case Tags.TAG_AXGLE_VIDEO:
                ...
                mCurrentFragment = FragmentUtils.switchContent(fragmentManager, mCurrentFragment, mainAxgleFragment, 
                        contentFrameLayout.getId(), itemId, isInnerReplace);
    ...
    private void handlerSecondTabClickToShow(String tag, int itemId, boolean isInnerReplace) {
        switch (tag) {
            case Tags.TAG_MEI_ZI_TU:
                ...
                mCurrentFragment = FragmentUtils.switchContent(fragmentManager, mCurrentFragment, 
                        mMaiMeiZiTuFragment, contentFrameLayout.getId(), itemId, isInnerReplace);
            ...
            case Tags.TAG_MM_99:
                ...
                //                }
                //                mCurrentFragment = FragmentUtils.switchContent(fragmentManager, mCurrentFragment, 
                // mMain99MmFragment, contentFrameLayout.getId(), itemId, isInnerReplace);
            ...
            case Tags.TAG_HUA_BAN:
                ...
                //                }
                //                mCurrentFragment = FragmentUtils.switchContent(fragmentManager, mCurrentFragment, 
                // mMainHuaBanFragment, contentFrameLayout.getId(), itemId, isInnerReplace);
                    ...
                    switch (which) {
                        case 0:
                            if (!presenter.isUserLogin()) {
                                ...
                                intent.putExtra(Keys.KEY_INTENT_LOGIN_FOR_ACTION, KeysActivityRequestResultCode
                                        .LOGIN_ACTION_FOR_SEARCH_91PRON_VIDEO);
